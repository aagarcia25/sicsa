...
import { DialogContent, Grid, IconButton, ToggleButton, Typography } from '@mui/material';
      ...
      renderCell: (v) => {
        return (
          <>
           ...
           <ButtonsDetail title={"Ver"} handleFunction={handleVer} show={true} icon={<RemoveRedEyeIcon/>} row={v}></ButtonsDetail>
           <ButtonsDetail title={"Descargar"} handleFunction={handleDescargarFile} show={true} icon={<DownloadingIcon/>} row={v}></ButtonsDetail>
          </>
