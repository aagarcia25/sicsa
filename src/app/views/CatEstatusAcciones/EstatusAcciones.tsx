...
import { EstatusAccionesModal } from "./EstatusAccionesModal";

export const EstatusAcciones = () => {
  ...
  useEffect(() => {
    permisos.map((item: PERMISO) => {
      if (String(item.ControlInterno) === "EACCIONES") {
  ...
  return (
    <div style={{ height: 600, width: "100%", padding: "1%" }}>
      ...
      <TitleComponent title={"Estatus Acciones"} show={openSlider} />
