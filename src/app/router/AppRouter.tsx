  ...
  return (
    <Inicio user={user} imgData={String(responseStorage?.FILE)} imgTipo={String(responseStorage?.TIPO)}>
      ...
      <Routes>
        ...
        <Route path='/inicio/admin/dash'    element={log ? <Dashboard /> : <AuthRouter />} />
        <Route path='/inicio/admin/ad'      element={log ? <Auditoria /> : <AuthRouter />} />
        ...
        <Route path='/inicio/catalogos/ea' element={log ? <EstatusAcciones /> : <AuthRouter />} />
        <Route path='/inicio/catalogos/gf' element={log ? <GrupoFuncional /> : <AuthRouter />} />
        <Route path='/inicio/catalogos/informe' element={log ? <Informe /> : <AuthRouter />} />
        <Route path='/inicio/catalogos/oa' element={log ? <OrigenAuditoria /> : <AuthRouter />} />
        <Route path='/inicio/catalogos/sector' element={log ? <Sector /> : <AuthRouter />} />
